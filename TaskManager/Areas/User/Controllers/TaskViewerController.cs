...
namespace TaskManager.Areas.User.Controllers
{
    ...
    {
        IKeyService<UserEntity> userService;
        IKeyService<TaskEntity> taskService;
        ITaskUserService taskUserService;

        public TaskViewerController(IKeyService<UserEntity> userService, IKeyService<TaskEntity> taskService, ITaskUserService taskUserService)
        {
